...
class Pagination
{
  ...
  public function getHtml(){
    ...
    return '<nav aria-label="Page navigation example"><ul class="pagination">' . $startpage.$back.$page2left.$page1left.'<li class="page-item active"><a class="page-link">'.$this->currentPage.'<span class="sr-only">(current)</span></a></li>'.$page1right.$page2right.$forward.$endpage . '</ul></nav>';
  }
